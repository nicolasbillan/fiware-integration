...
router.post('/', auth, async function (req, res, next) {
  ...
  await Travels.storeTravel(travel)
    .then(() => res.json(formatResponse(MESSAGES.TRAVEL_CREATED)))
    .catch((error) =>
      res.status(error.code ?? 500).json(formatResponse(error.message))
    );
});
...
router.put('/:id', auth, async function (req, res, next) {
  return Travels.getTravel(req.params.id, req.params.userId)
    ...
    .then(() => res.json(formatResponse(MESSAGES.TRAVEL_UPDATED)))
    .catch((error) =>
      res.status(error.code ?? 500).json(formatResponse(error.message))
    );
});
...
router.delete('/:id', auth, async function (req, res, next) {
  return Travels.getTravel(req.params.id, req.params.userId)
    ...
    .then(() => res.json(formatResponse(MESSAGES.TRAVEL_DELETED)))
    .catch((error) =>
      res.status(error.code ?? 500).json(formatResponse(error.message))
    );
});
...
router.post('/:id/expenses', auth, async function (req, res, next) {
  return Travels.getTravel(req.params.id, req.params.userId)
    ...
    .then(() => res.json(formatResponse(MESSAGES.EXPENSE_CREATED)))
    .catch((error) =>
      res.status(error.code ?? 500).json(formatResponse(error.message))
    );
});
...
router.put('/:id/expenses/:expId', auth, async function (req, res, next) {
  return Travels.getTravel(req.params.id, req.params.userId)
    ...
    .then(() => res.json(formatResponse(MESSAGES.EXPENSE_UPDATED)))
    .catch((error) =>
      res.status(error.code ?? 500).json(formatResponse(error.message))
    );
});
...
router.delete('/:id/expenses/:expId', auth, async function (req, res, next) {
  return Travels.getTravel(req.params.id, req.params.userId)
    ...
    .then(() => res.json(formatResponse(MESSAGES.EXPENSE_DELETED)))
    .catch((error) =>
      res.status(error.code ?? 500).json(formatResponse(error.message))
    );
});
